...
export const WithTitle: Story = {
  ...
  render: () => (
    <InteractiveModal title="Modal Title">
      ...
      <p className="mt-2 text-gray-600">
        The title is properly associated with the modal for screen readers.
      </p>
    </InteractiveModal>
  ),
};
...
export const SmallSize: Story = {
  ...
  render: () => (
    <InteractiveModal title="Small Modal" size="sm">
...
export const MediumSize: Story = {
  ...
  render: () => (
    <InteractiveModal title="Medium Modal" size="md">
      <p>This is a medium modal (max-width: 512px) - the default size.</p>
      <p className="mt-2 text-gray-600">
        Good for most dialog content and forms.
      </p>
    </InteractiveModal>
  ),
};
...
export const LargeSize: Story = {
  ...
  render: () => (
    <InteractiveModal title="Large Modal" size="lg">
...
export const ExtraLargeSize: Story = {
  ...
  render: () => (
    <InteractiveModal title="Extra Large Modal" size="xl">
      <p>This is an extra large modal (max-width: 896px).</p>
      <p className="mt-2 text-gray-600">
        Use for complex layouts, data tables, or rich content.
      </p>
    </InteractiveModal>
  ),
};
...
export const WithoutCloseButton: Story = {
  ...
  render: () => (
    <InteractiveModal title="No Close Button" showCloseButton={false}>
      <p>This modal doesn't have a close button in the header.</p>
      <p className="mt-2 text-gray-600">
        You can still close it by clicking the backdrop or pressing Escape.
      </p>
      <div className="mt-4">
...
export const FormExample: Story = {
  ...
  render: () => (
    <InteractiveModal title="Create New Item" size="md">
...
export const ConfirmationDialog: Story = {
  ...
  render: () => (
    <InteractiveModal title="Confirm Action" size="sm">
...
export const LongContentExample: Story = {
  ...
  render: () => (
    <InteractiveModal title="Terms of Service" size="lg">
      <div className="space-y-4 max-h-96 overflow-y-auto">
        ...
        <p className="text-gray-600">
          The materials on this service are provided on an 'as is' basis. This service
        ...
        <p className="text-gray-600">
          In no event shall this service or its suppliers be liable for any damages
          (including, without limitation, damages for loss of data or profit, or due to
          business interruption) arising out of the use or inability to use the materials
          on this service, even if this service or its authorized representative has been
    ...
    <InteractiveModal title="Accessibility Features">
      <div className="space-y-4">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-1">
          <li><kbd className="px-2 py-1 bg-gray-100 rounded text-xs">Escape</kbd> - Close modal</li>
          <li><kbd className="px-2 py-1 bg-gray-100 rounded text-xs">Tab</kbd> - Navigate focusable elements</li>
          <li><kbd className="px-2 py-1 bg-gray-100 rounded text-xs">Shift + Tab</kbd> - Navigate backwards</li>
        </ul>
...
export const DarkTheme: Story = {
  ...
  render: () => (
    <InteractiveModal title="Dark Theme Modal">
      ...
      <p className="mt-2 text-gray-600">
        The styling automatically adjusts for better visibility in dark mode.
      </p>
    </InteractiveModal>
  ),
  parameters: {
