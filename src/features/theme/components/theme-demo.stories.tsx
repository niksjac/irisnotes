  ...
  return (
    <div className="p-8 min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-700 dark:text-gray-200">
            This modal demonstrates how components adapt to the current theme.
            Notice how colors, borders, and backgrounds change seamlessly.
          </p>
          <Input
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Interactive demonstration of the theme system with light/dark mode switching and component adaptation.'
      }
    }
  },
  tags: ['autodocs'],
