...
import { hotkeyConfigurationAtom, detectConflictsAtom, updateBindingAtom, removeBindingAtom } from '../atoms';
import { HotkeyBinding, HotkeyScope } from '../types';
                ...
                >
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-2'>
                      <Button variant='secondary' size='sm' onClick={() => toggleBinding(binding)}>
                        {binding.enabled ? 'Disable' : 'Enable'}
                      </Button>
                      <Button variant='danger' size='sm' onClick={() => deleteBinding(binding.id)}>
                        Delete
                      </Button>
                    </div>
                  </div>
