...
import { hotkeyConfigurationAtom, registeredActionsAtom, addEventAtom } from '../atoms';
import { HotkeyBinding, HotkeyAction, HotkeyManagerOptions, HotkeyEvent } from '../types';
...
import { useSequenceShortcuts, useSequenceEvents } from './sequence-shortcuts';
