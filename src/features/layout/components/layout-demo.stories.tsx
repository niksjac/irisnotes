    ...
    <div className="w-full h-screen bg-gray-100 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Button
            variant={layout.sidebarCollapsed ? "primary" : "secondary"}
            size="sm"
          ...
          <Button
            variant={layout.toolbarVisible ? "secondary" : "primary"}
            size="sm"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-3">
          <Button
            variant={layout.configViewActive ? "secondary" : "ghost"}
            size="sm"
            onClick={layout.toggleConfigView}
          >
            Config View
          </Button>
          ...
          {layout.databaseStatusVisible && (
            <div className="absolute bottom-4 right-4 bg-green-100 dark:bg-green-900 border border-green-300 dark:border-green-700 rounded-lg p-3">
              <div className="flex items-center space-x-2">
                ...
                <button onClick={layout.toggleDatabaseStatus} className="text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-200">
                  ×
                </button>
              </div>
            </div>
      ...
      <div className="absolute top-20 left-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-lg">
        ...
        <div className="space-y-1 text-xs text-gray-600 dark:text-gray-300">
          ...
          {layout.isDualPaneMode && (
            <div>Active Pane: {layout.activePaneId}</div>
          )}
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Interactive demonstration of the layout system with sidebar, dual-pane editor, activity bar, and various views.'
      }
    }
  },
  tags: ['autodocs'],
