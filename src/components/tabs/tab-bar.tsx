...
export const TabBar: FC<TabBarProps> = ({
	...
	return (
		<div className={`flex items-center border-b border-gray-300 dark:border-gray-600 min-h-[40px] ${hasFocus ? "bg-blue-100 dark:bg-[#132247]" : "bg-gray-50 dark:bg-gray-800"}`}>
			{/* Tab list */}
