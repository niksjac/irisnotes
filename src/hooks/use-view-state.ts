...
export const useViewState = () => {
	...
	const [hotkeysViewActive, setHotkeysViewActive] = useAtom(
		hotkeysViewActiveAtom
	);
	const [databaseStatusVisible, setDatabaseStatusVisible] = useAtom(
		databaseStatusVisibleAtom
	);
	const [activityBarVisible, setActivityBarVisible] = useAtom(
		activityBarVisibleAtom
	);
